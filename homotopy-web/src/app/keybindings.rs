...
declare_keybindings! {
    ...
    "0" => Action::Proof(proof::Action::SelectGeneratorAt(0))
    "1" => Action::Proof(proof::Action::SelectGeneratorAt(1))
    "2" => Action::Proof(proof::Action::SelectGeneratorAt(2))
    "3" => Action::Proof(proof::Action::SelectGeneratorAt(3))
    "4" => Action::Proof(proof::Action::SelectGeneratorAt(4))
    "5" => Action::Proof(proof::Action::SelectGeneratorAt(5))
    "6" => Action::Proof(proof::Action::SelectGeneratorAt(6))
    "7" => Action::Proof(proof::Action::SelectGeneratorAt(7))
    "8" => Action::Proof(proof::Action::SelectGeneratorAt(8))
    "9" => Action::Proof(proof::Action::SelectGeneratorAt(9))
